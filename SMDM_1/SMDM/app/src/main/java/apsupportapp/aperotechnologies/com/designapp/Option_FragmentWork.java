...
public class Option_FragmentWork extends Fragment {
    TableLayout tableAOpt_Frag;
    TableLayout tableBOpt_Frag;
    TableLayout tableCOpt_Frag;
    TableLayout tableDOpt_Frag;
    TextView txtnounits;
    ViewGroup view;
...
//        TextView textView = this.bodyTextView(sampleObject.header1);
    ...
    public void requestProductArticleAllAPI(int offsetvalue1, int limit1) {
        ...
        //String url="https://ra.manthan.com/v1/display/collectionoptions/"+userId+"?collectionName="+collectionNM.replace(" ", "%20");
        Log.i("URL   ", url);
