...
import static apsupportapp.aperotechnologies.com.designapp.R.id.start;
import static apsupportapp.aperotechnologies.com.designapp.R.id.time;
...
public class DashBoardActivity1 extends AppCompatActivity
    ...
    private boolean geoLevelDesc = false;
...
//        LinearLayout linearLayout=(LinearLayout)findViewById(R.id.linear_ezone);
//        LayoutInflater layoutInflater1 = getLayoutInflater();
//        ViewGroup view = (ViewGroup) layoutInflater1.inflate(R.layout.activity_ezone_dashboard, null);
...
//        e.Ezone_DshBoard(view);
        //viewclass(view);
            ...
            if (Reusable_Functions.chkStatus(context)) {
                ...
                Toast.makeText(DashBoardActivity1.this, "Check your network connectivity", Toast.LENGTH_LONG).show();
            }
            RefreshTimeAPI();
   ...
   @Override
                    ...
                    public void onResponse(JSONArray response) {
                        try {
                            if (response.equals("") || response == null) {
                                Reusable_Functions.hDialog();
                                Toast.makeText(DashBoardActivity1.this, "No data found", Toast.LENGTH_LONG).show();
                            } else {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
            ...
            Intent intent = new Intent(DashBoardActivity1.this, LoginActivity1.class);
            ...
            Intent intent = new Intent(DashBoardActivity1.this, AboutUsActivity.class);
            startActivity(intent);
            finish();
            return true;
        }
    ...
    private void EventScroller() {
        ...
        adapter = new EventPagerAdapter(DashBoardActivity1.this, eventUrlList, li, pager);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn_mpm:
                Intent intent_mpm = new Intent(DashBoardActivity1.this, mpm_activity.class);
            ...
            case R.id.status:
                new StatusActivity().StartIntent(DashBoardActivity1.this);
                if (timer != null) {
                    timer.cancel();
                ...
                break;
            case R.id.to_do:
                new To_Do().StartIntent(DashBoardActivity1.this);
                if (timer != null) {
                    timer.cancel();
            ...
            case R.id.btnBestPerformers:
                Intent intent_best = new Intent(DashBoardActivity1.this, BestPerformerInventory.class);
            ...
            case R.id.btnFloorAvailability:
                Intent intent_floor = new Intent(DashBoardActivity1.this, FloorAvailabilityActivity.class);
            ...
            case R.id.btnTargetStockExcep:
                Intent intent_target = new Intent(DashBoardActivity1.this, TargetStockExceptionActivity.class);
            ...
            case R.id.btnSellThruExcep:
                Intent intent_sale = new Intent(DashBoardActivity1.this, SaleThruInventory.class);
            ...
            case R.id.btnStockAgeing:
                Intent intent_stock = new Intent(DashBoardActivity1.this, StockAgeingActivity.class);
            ...
            case R.id.btnSkewedSize:
                Intent intent_skew = new Intent(DashBoardActivity1.this, SkewedSizesActivity.class);
            ...
            case R.id.btnFeshnessindex:
                Intent intent_freshness = new Intent(DashBoardActivity1.this, FreshnessIndexActivity.class);
            ...
            case R.id.btnOptionEfficiency:
                Intent intent_option = new Intent(DashBoardActivity1.this, OptionEfficiencyActivity.class);
            ...
            case R.id.btnBestWorstpromo:
                Intent intent_best_worse = new Intent(DashBoardActivity1.this, BestPerformerActivity.class);
            ...
            case R.id.feedbackList_btn:
                new FeedbackList().StartIntent(DashBoardActivity1.this);
                if (timer != null) {
                    timer.cancel();
                }
                break;
            ...
            case R.id.feedback_btn:
                new Feedback().StartIntent(DashBoardActivity1.this);
                if (timer != null) {
                    timer.cancel();
                }
                break;
            case R.id.btnUpcomingpromo:
                Intent intent_upcoming = new Intent(DashBoardActivity1.this, UpcomingPromo.class);
            ...
            case R.id.btnExpiringpromo:
                Intent intent_exprinig = new Intent(DashBoardActivity1.this, ExpiringPromoActivity.class);
            ...
            case R.id.btnPVA:
                Intent intent = new Intent(DashBoardActivity1.this, SalesPvAActivity.class);
                startActivity(intent);
                if (timer != null) {
                    timer.cancel();
                }
                break;
            case R.id.btnSales:
                Intent intent1 = new Intent(DashBoardActivity1.this, SalesAnalysisActivity1.class);
            ...
            case R.id.btn_inspection_begin:
                Intent intent_insp = new Intent(DashBoardActivity1.this, InspectionBeginActivity.class);
            ...
            case R.id.btn_inspection_history:
                Intent intent_insp_history = new Intent(DashBoardActivity1.this, InspectionHistoryActivity.class);
            ...
            case R.id.imageBtnKeyProducts:
                Intent intent_key_product = new Intent(DashBoardActivity1.this, KeyProductActivity.class);
            ...
            case R.id.actualKeyProduct:
                Intent intent_plan_actual = new Intent(DashBoardActivity1.this, KeyProductPlanActivity.class);
            ...
            case R.id.imageBtnStyle:
                Intent intent_style = new Intent(DashBoardActivity1.this, StyleActivity.class);
            ...
            case R.id.btnVisualAssortment:
                Intent intent_visual_assort = new Intent(DashBoardActivity1.this, VisualAssortmentActivity.class);
            ...
            case R.id.btnVisualReport:
                Intent intent_visual_report = new Intent(DashBoardActivity1.this, VisualReportActivity.class);
            ...
            case R.id.btnRunningpromo:
                Intent intent_running_promo = new Intent(DashBoardActivity1.this, RunningPromoActivity.class);
