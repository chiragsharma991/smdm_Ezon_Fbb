...
public class SubCategory_childAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (VIEW_LIST == 1) {
            ...
            ViewHolder_List holderList = new ViewHolder_List(v);

//            holderList.bst_cardView.setOnClickListener(new View.OnClickListener() {
//                @Override
...
//            holderGrid.bst_cardView.setOnClickListener(new View.OnClickListener() {
//                @Override
//                public void onClick(View view) {
...
//            });
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int position) {
        ...
        if (holder instanceof ViewHolder_List) {
            ...
            ((ViewHolder_List) holder).bst_cardView.setOnClickListener(new View.OnClickListener() {
                @Override
    ...
    public class ViewHolder_List extends RecyclerView.ViewHolder {
        ...
        public ViewHolder_List(View itemView) {
            ...
            bst_cardView = (CardView) itemView.findViewById(R.id.bst_cardView);
