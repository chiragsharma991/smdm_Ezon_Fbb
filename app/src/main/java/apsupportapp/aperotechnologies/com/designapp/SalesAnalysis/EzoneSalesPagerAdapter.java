...
public class EzoneSalesPagerAdapter extends PagerAdapter implements ViewPager.OnPageChangeListener {
    ...
    TextView txt_ez_SohUVal, txt_ez_SohU;
    ...
    public Object instantiateItem(final ViewGroup container, final int position) {
        ...
        if (position == 0) {
            ...
            txt_ez_SohU.setText("SOH(U)");
            if (SalesAnalysisActivity1.ez_sales_header_model.equals("LD") || SalesAnalysisActivity1.ez_segment_val.equals("WTD")) {
