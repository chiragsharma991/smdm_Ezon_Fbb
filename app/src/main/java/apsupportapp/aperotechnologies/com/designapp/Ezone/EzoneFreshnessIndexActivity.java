...
public class EzoneFreshnessIndexActivity extends AppCompatActivity implements RadioGroup.OnCheckedChangeListener, HttpResponse, TabLayout.OnTabSelectedListener {
...
//        txtStoreDesc.setText(storeDescription.substring(5));
        ...
        Tabview.setOnTabSelectedListener(EzoneFreshnessIndexActivity.this);
    }
        ...
        switch (id) {
            ...
            case 0:
                ...
                if(from_filter)
                {
                    ...
                    {
                        url = ConstsCore.web_url + "/v1/display/inventoryassortmentnonassortmentheaderEZNew/" + userId + "?level=" + level +"&geoLevel2Code="+ geoLevel2Code + "&lobId="+ lobId;
                    }
                            ...
                            switch (txtFIndexClass.getText().toString()) {
                                ...
                                case "Department":
                                    ...
                                    if (Reusable_Functions.chkStatus(context)) {
                                        ...
                                        txtfIndexDeptName.setText(hierarchy(freshnessIndex_ClickedVal.replaceAll("%20"," ").replaceAll("%26","&")));
                                        mpm_model model = new mpm_model();
