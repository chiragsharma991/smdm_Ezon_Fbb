...
public class OurStoreServices_Feedback extends Fragment implements View.OnClickListener, HttpPostResponse {
...
//
    ...
    public void PostResponse(JSONObject response) {
        ...
        try {
            ...
            req_sms_API(userId, customerNumber, bearertoken, customerCallBack,  context, "ourstoreservices",store_code);
            cancelData();
