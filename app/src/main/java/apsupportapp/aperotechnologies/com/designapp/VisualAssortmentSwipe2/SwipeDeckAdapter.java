...
public class SwipeDeckAdapter extends BaseAdapter {
    ...
    public SwipeDeckAdapter(ArrayList<VisualAssortCombo> visualAssortCombosList, Context context, SwipeDeck cardStack) {
        this.visualAssortCombosList = visualAssortCombosList;
    ...
    @Override
    public int getCount() {
        return visualAssortCombosList.size();
    }

    @Override
    public Object getItem(int position) {
        return visualAssortCombosList.get(position);
    }
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
       ...
       /* btnlike = (RelativeLayout) layoutView.findViewById(R.id.imgbtnlike);
        ...
        VisualAssortCombo visualAssortCombo = visualAssortCombosList.get(position);
        ...
        txtAmount.setText("\u20B9 "+String.valueOf(visualAssort.getUnitGrossPrice()));
        txtSizeRatio.setText("Size Ratio : " +visualAssort.getSize());

        if(position == 0)
        {
            VisualAssortCombo visualAssortCombo1 = visualAssortCombosList.get(0);
            ...
            if(visualAssortComment1.getLikeDislikeFlg().equals("1"))
            {
            ...
            else if(visualAssortComment1.getLikeDislikeFlg().equals("0"))
            {
            ...
            if(visualAssortComment1.getFeedback() != null) {
                if (!visualAssortComment1.getFeedback().equals("")) {
                    VisualAssortmentActivity.edtTextComment.setText(visualAssortComment1.getFeedback());
                } else {
...
//
            if(visualAssortComment1.getSizeSet() != 0)
            {
                VisualAssortmentActivity.edtTextSets.setText(String.valueOf(visualAssortComment1.getSizeSet()));
            }
            else
            {
