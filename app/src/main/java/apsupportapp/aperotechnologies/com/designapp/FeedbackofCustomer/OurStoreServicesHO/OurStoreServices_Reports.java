...
import static apsupportapp.aperotechnologies.com.designapp.FeedbackofCustomer.OurStoreServicesHO.OurStoreServices_Reports.card_ourstore;
import static apsupportapp.aperotechnologies.com.designapp.FeedbackofCustomer.OurStoreServicesHO.OurStoreServices_Reports.relFIndexTablelayout_store;
import static apsupportapp.aperotechnologies.com.designapp.FeedbackofCustomer.OurStoreServicesHO.OurStoreServices_Reports.text_no_data_store;
...
public class OurStoreServices_Reports extends Fragment  implements TabLayout.OnTabSelectedListener, HttpResponse, OnChartValueSelectedListener,OurStoreServices_ReportAdapter.RecyclerViewclick{
    ...
    public static RelativeLayout relFIndexTablelayout_store;
    ...
    private void initialiseUI() {
        ...
        card_ourstore = (CardView) v.findViewById(R.id.cf_cardView);
        relFIndexTablelayout_store = (RelativeLayout) v.findViewById(R.id.relFIndexTablelayout_store);
        storedesc = (TextView) v.findViewById(R.id.txtStoreCode);
        text_no_data_store =(TextView) v.findViewById(R.id.text_no_data_store);
...
//                relFIndexTablelayout_store.setVisibility(View.VISIBLE);
    ...
    private void setlistView(ArrayList<mpm_model> callbacklist)
    {
        ...
        adapter = new OurStoreServices_ReportAdapter(callbacklist, context,this);
...
class ApiRequestNew_storeServices {
    ...
    public ApiRequestNew_storeServices(Context context, String token, String Url, String TAG, RequestQueue queue, mpm_model mpm_modelClass, int id)
    {
    ...
    public ApiRequestNew_storeServices(Context context, String token, String Url, String TAG, RequestQueue queue, mpm_model mpm_modelClass, int id, HttpResponse httpResponse, String data) {
...
//                                Toast.makeText(context, "inside null response",Toast.LENGTH_SHORT).show();
                                card_ourstore.setVisibility(View.GONE);
                                relFIndexTablelayout_store.setVisibility(View.GONE);
                                text_no_data_store.setVisibility(View.VISIBLE);
