...
import static apsupportapp.aperotechnologies.com.designapp.FeedbackofCustomer.ProductQualityRangeHO.ProductQualityRange_Reports.card_quality;
import static apsupportapp.aperotechnologies.com.designapp.FeedbackofCustomer.ProductQualityRangeHO.ProductQualityRange_Reports.relFIndexTablelayout_quality;
import static apsupportapp.aperotechnologies.com.designapp.FeedbackofCustomer.ProductQualityRangeHO.ProductQualityRange_Reports.text_no_data_quality;

/**
 * Created by rkanawade on 25/07/17.
 */

public class ProductQualityRange_Reports extends Fragment implements TabLayout.OnTabSelectedListener, HttpResponse, OnChartValueSelectedListener,ProductQuality_ReportAdapter.RecyclerViewclick{
    ...
    public static CardView card_quality;
    public static RelativeLayout relFIndexTablelayout_quality;
    private ProgressBar processbar_view;
    private LinearLayout addleggend;
    public static TextView text_no_data_quality;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        context = getContext();
        View view = inflater.inflate(R.layout.fragment_productqualityrange_reports, container, false);
        return view;
    }
    ...
    private void initialiseUI() {
        ...
        card_quality = (CardView) v.findViewById(R.id.cf_cardView);
        relFIndexTablelayout_quality = (RelativeLayout) v.findViewById(R.id.relFIndexTablelayout_quality);
        ...
        text_no_data_quality =(TextView) v.findViewById(R.id.text_no_data_quality);
    ...
    public void response(ArrayList<mpm_model> list, int id) {
        ...
        switch (id) {
            ...
            case 0:
                card_quality.setVisibility(View.VISIBLE);
                relFIndexTablelayout_quality.setVisibility(View.VISIBLE);
                text_no_data_quality.setVisibility(View.GONE);
...
//                relFIndexTablelayout_quality.setVisibility(View.VISIBLE);
    ...
    private void setlistView(ArrayList<mpm_model> callbacklist)
    {
        ...
        adapter = new ProductQuality_ReportAdapter(callbacklist, context,this);
...
class ApiRequestNew_quality {
    ...
    public ApiRequestNew_quality(Context context, String token, String Url, String TAG, RequestQueue queue, mpm_model mpm_modelClass, int id)
    {
    ...
    public ApiRequestNew_quality(Context context, String token, String Url, String TAG, RequestQueue queue, mpm_model mpm_modelClass, int id, HttpResponse httpResponse, String data) {
...
//                                Toast.makeText(context, "inside null response",Toast.LENGTH_SHORT).show();
                                card_quality.setVisibility(View.GONE);
                                relFIndexTablelayout_quality.setVisibility(View.GONE);
                                text_no_data_quality.setVisibility(View.VISIBLE);
