...
import apsupportapp.aperotechnologies.com.designapp.FeedbackofCustomer.PricePromotionHO.Adapter.PricePromotion_ViewPagerAdapter;
import apsupportapp.aperotechnologies.com.designapp.R;

public class PricePromotion_HO extends AppCompatActivity {
    TabLayout tabLayout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_price_promotion_ho);
        ...
        final PricePromotion_ViewPagerAdapter adapter = new PricePromotion_ViewPagerAdapter
