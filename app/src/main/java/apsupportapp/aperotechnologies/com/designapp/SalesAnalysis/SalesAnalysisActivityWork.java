 ...
 */
public class SalesAnalysisActivityWork extends AppCompatActivity implements RadioGroup.OnCheckedChangeListener {
...
//                    int val = arrayList.size() - listView_SalesAnalysis.getFirstVisiblePosition();
//
//                    for(int i = 0; i < val; i++)
//                    {
...
//                    }
                    ...
                    Log.e("firstVisibleItem"," "+listView_SalesAnalysis.getFirstVisiblePosition() + " "+(arrayList.size() - listView_SalesAnalysis.getFirstVisiblePosition()));
...
//                initialiseUIElements(context);
                ...
                new Response.Listener<JSONArray>() {
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        try {
                            ...
                            {
                                Reusable_Functions.hDialog();
                                Toast.makeText(SalesAnalysisActivityWork.this.context, "no product data found", Toast.LENGTH_LONG).show();
                            }
    ...
    public void onBackPressed() {
        SalesPagerAdapter.currentPage = 0;
        Intent i = new Intent(SalesAnalysisActivityWork.this, DashBoardActivity.class);
        startActivity(i);
        finish();
    }
}
