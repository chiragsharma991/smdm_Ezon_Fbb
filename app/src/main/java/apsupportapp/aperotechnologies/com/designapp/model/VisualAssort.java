...
public class VisualAssort {
    ...
    private String prodAttribute2;
    private String prodImageURL;
    private String prodLevel1Code;
    private String prodLevel1Desc;
    private String prodLevel2Code;
    private String prodLevel2Desc;
    private String prodLevel3Code;
    private String prodLevel3Desc;
    private String prodLevel4Code;
    private String prodLevel4Desc;
    private String prodLevel5Code;
    private String prodLevel5Desc;
    private String prodLevel6Code;
    private String prodLevel6Desc;
    private String productName;
    private String collectionName;
    private String productFabricCode;
    private String productFabricDesc;
    private String productFinishCode;
    private String productFinishDesc;
    private String productFitCode;
    private String productFitDesc;
