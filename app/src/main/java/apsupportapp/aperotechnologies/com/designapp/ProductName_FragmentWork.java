 ...
 */
public class ProductName_FragmentWork extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        btnFilter=(Button)view.findViewById(R.id.imageBtnFilter);
       ...
       /* btnFilter.setOnClickListener(new View.OnClickListener() {
        ...
        //if(KeyProductActivity.viewPager.getCurrentItem() == 0) {
            ...
            if (Reusable_Functions.chkStatus(context)) {
                ...
                if (SearchActivity1.searchSubDept.equals("") && SearchActivity1.searchProductName.equals(""))// && SearchActivity1.searchArticleOption.equals(""))
                {
                ...
                if (!SearchActivity1.searchSubDept.equals("")) {
                    ...
                    txt_subdepName.setText(SearchActivity1.searchSubDept.replace("%20", " "));
