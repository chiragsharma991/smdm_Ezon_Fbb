...
/**
 * Created by csuthar on 22/11/16.
 */
...
public class WorstPromoAdapter extends BaseAdapter {
    ...
    public WorstPromoAdapter(ArrayList<RunningPromoListDisplay> arrayList, Context context) {
