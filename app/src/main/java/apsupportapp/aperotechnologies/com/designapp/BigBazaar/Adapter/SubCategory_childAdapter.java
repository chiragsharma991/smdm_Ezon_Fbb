...
// VIEW_LIST=1 , VIEW_LIST=2
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (VIEW_LIST == 1) {
            ...
            holderList.title.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    Log.e(TAG, "onClick: "+holderList.getAdapterPosition()+" " );
                    listner.onclickPostion(VIEW_LIST,holderList.getAdapterPosition());
                }
            });
            ...
            holderGrid.cutofprice.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    Log.e(TAG, "onClick: "+holderGrid.getAdapterPosition()+" " );
                    listner.onclickPostion(VIEW_LIST,holderGrid.getAdapterPosition());
    ...
    public interface onclick {
        void onclickPostion (int parent , int child);
    }
